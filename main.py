...
def song_changed(title, artist, pulse_id):
...
parser.add_argument('-d', action='store_true', help='enable run-in-background-mode')
...
while True:
    ...
    while True:
        ...
        if title != last_title or artist != last_artist:
            song_changed(title, artist, pulse_id)
